...
import com.dlm.bdp.bam_basemanagement.service.SurnameInfoService;
import com.dlm.bdp.mapper.SurnameInfoMapper;
import com.dlm.bdp.pojo.SurnameInfo;
import com.dlm.bdp.pojo.SurnameInfoExample;
import com.dlm.bdp.pojo.SurnameInfoExample.Criteria;
...
public class SurnameInfoServiceImpl implements SurnameInfoService {
	...
	@Override
	public List<SurnameInfo> findSurnameInfoListLike(String surname) {
		SurnameInfoExample example = new SurnameInfoExample();
		Criteria criteria = example.createCriteria();
		if(StringUtils.isNotBlank(surname)) {
			criteria.andSurnameLike(surname+"%");
		}
		return mapper.selectByExample(example);
	}
