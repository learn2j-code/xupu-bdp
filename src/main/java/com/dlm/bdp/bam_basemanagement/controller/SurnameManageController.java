...
public class SurnameManageController {
	...
	public @ResponseBody ResponseEntity findAll(@RequestBody SurnameInfo record) {
		ResponseEntity responseEntity = new ResponseEntity();
		Map<String, Object> data = new HashMap<String, Object>();
		
		List<SurnameInfo> surnameList = surnameInfoService.findSurnameInfoListLike(record.getSurname());
