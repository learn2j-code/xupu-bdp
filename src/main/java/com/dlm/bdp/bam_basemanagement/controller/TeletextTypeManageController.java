...
@Controller
@RequestMapping("teletexttype")
public class TeletextTypeManageController {
	@Autowired
	TeletextTypeService service;	
	...
	public @ResponseBody ResponseEntity findAll(){
		...
		List<TeletextType> list = service.list();
		data.put("list", list);
	...
	public @ResponseBody ResponseEntity findById(@RequestBody TeletextType parameter){
		ResponseEntity responseEntity = new ResponseEntity();
		Map<String, Object> data = new HashMap<String, Object>();
		
		TeletextType record = service.get(parameter.getId());
	 ...
	 */
	@RequestMapping("add")
	public @ResponseBody ResponseEntity add(@RequestBody TeletextType parameter){
		ResponseEntity responseEntity = new ResponseEntity();
		try {
	...
	public @ResponseBody ResponseEntity update(@RequestBody TeletextType record){
		ResponseEntity responseEntity = new ResponseEntity();
		try {
	...
	public @ResponseBody ResponseEntity deleteById(@RequestBody TeletextType record){
		ResponseEntity responseEntity = new ResponseEntity();
		try {
